...
import com.jb.medineed.app.presentation.components.PreferenceSingleChoiceItem
import com.jb.medineed.app.presentation.components.PreferenceSubtitle
import com.jb.medineed.app.util.LocaleLanguageCodeMap
            ...
            LazyColumn(modifier = Modifier, contentPadding = it) {
                ...
                if (isSystemLocaleSettingsAvailable) {
                    item {
                        ...
                        Surface(
                            modifier = Modifier.clickable(onClick = onNavigateToSystemLocaleSettings)
                        ) {
                            Row(
                                modifier = Modifier
                                    .fillMaxWidth()
