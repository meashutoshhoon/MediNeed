package com.jb.medineed.app.presentation.page.settings
...
import com.jb.medineed.app.presentation.components.PreferencesHintCard
import com.jb.medineed.app.presentation.components.SettingItem
...
fun SettingsPage(onNavigateBack: () -> Unit, onNavigateTo: (String) -> Unit) {
    ...
    val isActivityAvailable: Boolean = if (Build.VERSION.SDK_INT < 33) context.packageManager.queryIntentActivities(
            intent,
